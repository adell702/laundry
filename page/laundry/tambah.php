...
if (isset($_POST['tambah'])) {
  ...
  $query = "INSERT INTO `tb_transaksi` (`id_laundry`, `pelangganid`, `userid`, `kd_jenis`, `tgl_terima`, `tgl_selesai`, `jml_kilo`, `catatan`, `totalbayar`, `status_pembayaran`,`status_pengambilan`) VALUES ('$idlaundry', '$pelangganid', '$userid', '$jenis', '$tgl_terima', '$tgl_selesai', '$jml_kilo', '$catatan', '$totalbayar', '$status','$status_pengambilan')";
  ...
  <div class="row">
      ...
      <?php endif; ?>
          ...
          <div class="card m-b-100">
            ...
            $q = mysqli_query($conn, "SELECT MAX(RIGHT(id_laundry,4)) AS kd_max FROM tb_transaksi");
