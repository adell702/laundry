...
$query = mysqli_query($conn, "SELECT * FROM tb_transaksi WHERE id_laundry = '$id'");
...
$result = mysqli_query($conn, "UPDATE tb_transaksi SET `status_pembayaran` = 1 WHERE id_laundry = '$id'");
