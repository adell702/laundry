...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="assets/images/logologin.png" type="image/png"/>
        <title>Login AAA Laundry</title>
    ...
    <style>
        .accountbg {
            background-image: url('assets/images/bglaundryy.jpg');
            ...
            <div class="card">
                <div class="card-body">
                    <h3 class="text-center mt-0 m-b-15">
                        <a href="login.php"><img src="assets/images/logologin.png" width="200px"></a>
                    </h3>

                    <div class="p-3">
                        <h4 class="text-center mt-0 m-b-15">Login AAA Laundry</h4>
